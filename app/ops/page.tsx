    ...
    <main className="min-h-screen bg-[#f1f3e9]">
      ...
      <div className="pt-32 pb-20 container-custom">
        ...
        <p className="text-[#234934]/70 text-lg">
          Meet our partner organizations that make volunteer experiences possible.
        </p>
        {/* OPs page content will be developed */}
        <div className="mt-12 p-8 bg-white rounded-2xl text-center">
          <p className="text-[#234934]/60">Full OPs page coming soon...</p>
        </div>
      </div>
      <Footer />
    </main>
